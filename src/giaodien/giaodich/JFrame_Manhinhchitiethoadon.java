 ...
 * @author USER
 */
public class JFrame_Manhinhchitiethoadon extends javax.swing.JFrame {

    /**
     * Creates new form JFrame_Manhinhchitiethoadon
     */
    public JFrame_Manhinhchitiethoadon() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_Manhinhchitiethoadon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_Manhinhchitiethoadon().setVisible(true);
            }
        });
    }
